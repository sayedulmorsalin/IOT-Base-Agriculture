...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->button1->Location = System::Drawing::Point(491, 343);
			this->button1->Margin = System::Windows::Forms::Padding(4);
			this->button1->Name = L"button1";
			this->button1->Size = System::Drawing::Size(224, 56);
			...
			this->button2->Location = System::Drawing::Point(491, 429);
			this->button2->Margin = System::Windows::Forms::Padding(4);
			this->button2->Name = L"button2";
			this->button2->Size = System::Drawing::Size(224, 56);
			...
			this->label2->Location = System::Drawing::Point(608, 134);
			...
			this->label3->Location = System::Drawing::Point(485, 184);
			this->label3->Name = L"label3";
			this->label3->Size = System::Drawing::Size(397, 32);
			this->label3->TabIndex = 4;
			this->label3->Text = L"Login by your id and password";
			this->label3->Click += gcnew System::EventHandler(this, &MyForm1::label3_Click);
			// 
			// MyForm1
			// 
			this->AutoScaleDimensions = System::Drawing::SizeF(20, 38);
			this->AutoScaleMode = System::Windows::Forms::AutoScaleMode::Font;
			this->BackColor = System::Drawing::SystemColors::ActiveCaption;
			this->ClientSize = System::Drawing::Size(1351, 655);
			this->Controls->Add(this->label3);
			this->Controls->Add(this->label2);
			this->Controls->Add(this->button2);
			this->Controls->Add(this->button1);
			this->Controls->Add(this->label1);
			this->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 19.8F, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
...
private: System::Void button1_Click(System::Object^ sender, System::EventArgs^ e) {
	this->Hide();
	MyForm2^ obj3 = gcnew MyForm2();
	obj3->ShowDialog();
}
private: System::Void button2_Click_1(System::Object^ sender, System::EventArgs^ e) {
	this->Hide();
	MyForm3^ obj4 = gcnew MyForm3();
	obj4->ShowDialog();
}
};
}
