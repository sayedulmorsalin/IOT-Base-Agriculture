...
namespace Project2 {
	...
	public:
		MyForm17(int n7, int n8, int n9, int n10)
		{
			InitializeComponent();
			//
			//TODO: Add the constructor code here
			...
			String^ totals = n7.ToString() + " KG growing now ";
			this->label4->Text = totals;
			String^ totals1 = n8.ToString() + " KG growing now ";
			this->label3->Text = totals1;
			String^ totals2 = n9.ToString() + " KG growing now ";
			this->label5->Text = totals2;
			String^ totals3 = n10.ToString() + " KG growwing now ";
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			// button5
			// 
			this->button5->Location = System::Drawing::Point(28, 24);
			...
			this->button4->Location = System::Drawing::Point(119, 359);
			...
			this->button3->Location = System::Drawing::Point(119, 241);
			...
			this->button2->Location = System::Drawing::Point(119, 299);
			...
			this->button1->Location = System::Drawing::Point(119, 184);
